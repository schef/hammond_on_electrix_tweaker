...
#define ZYNTHIAN_UI_SELECT 51
    if (byte2 == 0) {
      MidiPlayer::getInstance()->sendMessageOutTweaker(MidiParser::NOTE_ON_C16, ZYNTHIAN_UI_SELECT, 0);
    }
    break;
...
#define ZYNTHIAN_UI_SELECT_DOWN 53
    if (byte2 == TRACK_SELECT_CLOCKWISE) {
      MidiPlayer::getInstance()->sendMessageOutTweaker(MidiParser::NOTE_ON_C16, ZYNTHIAN_UI_SELECT_DOWN, 0);
    } else if (byte2 == TRACK_SELECT_ANTICLOCKWISE) {
      MidiPlayer::getInstance()->sendMessageOutTweaker(MidiParser::NOTE_ON_C16, ZYNTHIAN_UI_SELECT_UP, 0);
    }
    break;
